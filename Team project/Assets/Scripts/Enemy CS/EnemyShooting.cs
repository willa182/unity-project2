...
public class EnemyShooting : MonoBehaviour
{
    ...
    public Transform firePoint; // Expose this variable in the Inspector
    ...
    void Shoot()
    {
        ...
        if (firePoint == null)
        {
            Debug.LogError("Fire point not assigned for EnemyShooting on " + name);
            return;
        }

        GameObject bullet = Instantiate(bulletPrefab, firePoint.position, firePoint.rotation); // Use firePoint.rotation
