...
- A tutorial for creating a working scene with vehicles in less than 60 seconds (see the online documentacion)
- Updates and previous versions via GIT (http://projects.edy.es/trac/edy_vehicle-physics)

How to use it:
1- Import the package into an EMPTY project
2- Quit Unity, then move the InputManager.asset file to the project's Library folder
3- Open the project in Unity, load the scene TheCity and click Play. Done!

Feature list and full documentation available here:
http://projects.edy.es/trac/edy_vehicle-physics

Live demo:
http://www.edy.es/unity/offroader.html

Videos:
http://www.youtube.com/playlist?list=PLB7AEBA14B84643F2
